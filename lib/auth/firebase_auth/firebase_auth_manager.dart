...
// import 'package:demo_app/auth/base_auth_user_provider.dart';
// // import '../../flutter_flow/flutter_flow_util.dart';
// import 'package:demo_app/auth/firebase_auth/ff_util.dart';
...
// export 'package:demo_app/auth/base_auth_user_provider.dart';
...
//     try {
//       if (!loggedIn) {
//         log('Error: delete user attempted with no logged in user!');
//         // return;
//       }
//       currentUser?.delete();
...
//     try {
//       if (!loggedIn) {
//         log('Error: update email attempted with no logged in user!');
//         // return;
//       }
//       currentUser?.updateEmail(email);
//       updateUserDocument(email: email);
//     } on FirebaseAuthException catch (e) {
//       if (e.code == 'requires-recent-login') {
//         ScaffoldMessenger.of(context).hideCurrentSnackBar();
//         ScaffoldMessenger.of(context).showSnackBar(
...
//   ) async {
//     try {
//       final userCredential = signInFunc();
//       if (userCredential?.user != null) {
//         maybeCreateUser(userCredential!.user!);
//       }
